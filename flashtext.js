 ...
 * aend fade away again, to visualize gathered points in a game for example.
 *
 * Copyright 2011 Sebastian Herrlinger
 */
 kk.FlashText = function(options){
    ...
    this.shadowColor = ((options.shadowColor) ? hex2rgb(options.shadowColor) : false) || hex2rgb('#aaa');
